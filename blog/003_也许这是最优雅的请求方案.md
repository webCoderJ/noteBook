我相信跟我一样的前端狗早就写烦了各种请求，写烦了各种路径，大家在项目中请求的方式都各不相同，但是万变不离其宗。来看看以下大家常用的请求方式弊端分析，看看是不是也有类似的痛点，以vue + axios项目为例。
...
上面说了一大堆废话，怼了那么多问题。特么要是没拿出个好看的方案，劳资嫩死你...，各位别着急，听..听我慢慢说...
...
以上的解决方式仅仅是一种思路，具体的代码实现上可以根据项目的框架、实际引用的请求库、业务需求来封装。当然，如果恰好你跟我的业务需求差不多，以上的代码可以满足业务，我把代码已经放到了github，欢迎大家使用。